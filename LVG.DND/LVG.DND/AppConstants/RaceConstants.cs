...
namespace LVG.DND.AppConstants
{
    public class RaceConstants
    {
        ...
        public static Race DWARF = new Race()
        {
            ...
            ItemProficiencies = new List<string> { "Choice" },//artisan's tools of choice: smith's tools, brewer's supplies or mason's tools
            ASBonus = new List<RaceAbilityScoreBonus>
                    {
                        new RaceAbilityScoreBonus{Bonus = 2, AbilityScoreName = "Dexterity"}
                    },
        ...
        public static Race HALF_ELF = new Race()
        {
            Name = "Half Elf",
        ...
        public static Race HALF_ORC = new Race()
        {
            Name = "Half Orc",
